...
return [
    ...
    'settings'      => [
        'default' => [
            ...
            'CSS.AllowedProperties'    => 'font-weight,padding,padding-top,padding-bottom,font-style,text-decoration,color,background-color,text-align,border,border-top,border-left,border-bottom,border-right',
